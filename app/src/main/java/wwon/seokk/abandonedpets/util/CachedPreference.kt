 ...
 **/
abstract class CachedPreference constructor(@ApplicationContext private val context: Context, private val name: String) {
    ...
    private fun preLoad() {
        ...
        all.keys.toList().forEach { k: String -> cache[k] = all[k] }
    }
